...
## 🏛️ 1. LIETUVOS PAJŪRIO PERLAI (Išvykstant)

Prieš kertant sieną, verta užsukti į šias vietas:

*   **🌅 [Olando Kepurė](https://www.google.com/maps/search/?api=1&query=Olando+Kepur%C4%97)** – Aukščiausias Lietuvos pajūrio skardis. Nuostabi panorama ir pasivaikščiojimo takai pušynais.
*   **⚓ [Karklės senosios kapinės](https://www.google.com/maps/search/?api=1&query=Karkl%C4%97s+kapin%C4%93s)** – Romantiška ir liūdna vieta ant paties jūros kranto, kur ilsisi senieji kuršininkai.
*   **🏰 [Palangos Gintaro muziejus ir Birutės parkas](https://www.google.com/maps/search/?api=1&query=Palangos+gintaro+muziejus)** – Klasika, bet jei turite laiko, grafų Tiškevičių dvaro sodas yra viena gražiausių vietų Lietuvoje.
*   **🏄‍♂️ [313 Cable Park](https://www.google.com/maps/search/?api=1&query=313+Cable+Park)** – Jei vaikai nori aktyvumo, tai vienas moderniausių batutų ir vandenlenčių parkų Europoje (prie pat kelio link Šventosios).

---

## 🐒 2. ŠVENTOJI: Trumpas "Retro" Sustojimas

*   **🌉 [Beždžionių tiltas](https://www.google.com/maps/search/?api=1&query=Be%C5%BEd%C5%BEioni%C5%B3+tiltas+%C5%A0ventoji)** – Simbolinis tiltas per Šventosios upę. Vaikams visada atrakcija juo pereiti.
*   **🗿 [Žvejų dukros](https://www.google.com/maps/search/?api=1&query=%C5%BDvej%C5%B3+dukros+%C5%A0ventoji)** – Įspūdinga skulptūra kopose, žvelgianti į jūrą.
